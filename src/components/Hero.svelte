<!-- <div class="section pt-32">
    <h1 class="text-7xl heading">Welcome to <br /> my personal portfolio</h1>
    <p class="description">I'm a 15 year old fullstack web and discord bot developer <br />specialising in typescript</p>
    <a class="w-64 h-16 font-bold bg-purple-500 rounded-full text-2xl flex items-center justify-center mt-8" href="https://github.com/thereal-atom">Learn more</a>
    <div class="w-16 h-2 bg-purple-500 mt-16 rounded-full break"><p class="opacity-0">a</p></div>
</div>

<style>
    a{  
        background-image: linear-gradient(to right, rgb(162, 0, 255), rgb(0, 217, 255));
    }
    svg{
        position: absolute;
        width: 500px;
...
<div class="container">
    <div class="left-section">
        <h1 class="section-title">Welcome to <br /> My personal portfolio</h1>
        <p class="section-text">I'm a 15 year old self taught back-end web developer <br /> and DevOps engineer.</p>
